...
(`compile` vs `parse`). `PMT` and `NOMINAL` live in
...
- `NOMINAL(effect_rate, npery)`: OpenFormula 6.12.32
  ...
  the identity; overflow is `#NUM!`. `EFFECT` is a later workstream.
