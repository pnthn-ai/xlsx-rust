...
| [`dates.rs`](crates/xlsx-engine-core/src/dates.rs) | 1900/1904 serials, leap-year bug, `EOMONTH` / `NETWORKDAYS` / `NETWORKDAYS.INTL` / `WEEKDAY` / `WEEKNUM` / `WORKDAY` / `WORKDAY.INTL` / `YEARFRAC` |
