...
(`compile` vs `parse`). `PMT` and `EFFECT` live in
...
- `EFFECT(nominal_rate, npery)`: OpenFormula 6.12.19
  ...
  the identity; overflow is `#NUM!`. `NOMINAL` is a later workstream.
