...
pub use financial::{
    ...
    cumprinc_naive as excel_cumprinc_naive, effect as excel_effect, effect_naive as excel_effect_naive,
    fv as excel_fv, fv_naive as excel_fv_naive, ipmt as excel_ipmt, ipmt_naive as excel_ipmt_naive,
    nominal as excel_nominal, nominal_naive as excel_nominal_naive, nper as excel_nper,
    nper_naive as excel_nper_naive, pduration as excel_pduration,
    pduration_naive as excel_pduration_naive, pmt as excel_pmt, ppmt as excel_ppmt,
    ppmt_naive as excel_ppmt_naive, pv as excel_pv, pv_naive as excel_pv_naive, rate as excel_rate,
    rate_naive as excel_rate_naive, rri as excel_rri, rri_naive as excel_rri_naive, RATE_MAX_ITERS,
    RATE_TOL,
};
