...
//! Financial TVM: `PMT` / `CUMPRINC` (`xlsx_types::excel_pmt` /
//! `xlsx_types::excel_cumprinc`); `PV`/`FV`/`NPER` are later workstreams.
...
use xlsx_types::{
    count_matches, excel_ceiling, excel_ceiling_math, excel_cumprinc, excel_floor,
    excel_floor_math, excel_pmt, Criterion, EvalError, ExcelError, ExcelValue,
};
