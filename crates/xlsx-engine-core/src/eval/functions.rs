...
//! Financial TVM: `PMT` / `IPMT` (`xlsx_types::excel_pmt` / `excel_ipmt`).
//! `PV`/`FV`/`NPER` are later workstreams.
...
use xlsx_types::{
    count_matches, excel_ceiling, excel_ceiling_math, excel_floor, excel_floor_math, excel_ipmt,
